...
import { IIntegrationEntitySettingTied, IntegrationEntity, ITenant } from '@worksuite/contracts';
import { PROJECT_TIED_ENTITIES } from '@worksuite/integration-hubstaff';
